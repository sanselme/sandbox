...
struct RootNode: MatterNode {
  typealias AttributeCallback = (
    MatterAttributeEvent, Endpoint, Cluster, UInt32, UnsafeMutablePointer<esp_matter_attr_val_t>?
  ) -> Void
  typealias identifyCallback = (esp_matter.identification.callback_type_t, UInt16, UInt8, UInt8) ->
    Void
